...
def convert_bytes_to_cert(bytes_cert: bytes) -> dict | None:
    cert = None
    try:
    ...
    try:
        result["validity"] = {}
        result["validity"]["end_datetime"] = cert.not_valid_after_utc
        result["validity"]["start_datetime"] = cert.not_valid_before_utc
    ...
    result.pop("serialNumber_int", None)
    return result


# noinspection PyBroadException
def get_certificate_domains(cert: Certificate) -> list[str] | None:
    """
